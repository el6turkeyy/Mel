...
function unlock_waring(msg)
  ...
  else redis:set(matrex..'lock_woring'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(matrex..'lock_woring'..msg.chat_id_) then 
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**التحذير بالتأكيد معطل\n✓" 
  else
  redis:del(matrex..'lock_woring'..msg.chat_id_) 
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(matrex..'lock_id'..msg.chat_id_) then 
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**الايدي بالتأكيد معطل\n✓" 
  else
  redis:del(matrex..'lock_id'..msg.chat_id_) 
  ...
  redis:set(matrex..'lock_id'..msg.chat_id_,true)  
  ...
  else redis:set(matrex..'welcome:get'..msg.chat_id_,true)  
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(matrex..'welcome:get'..msg.chat_id_) then 
  ...
  matrex..'mute_gif'..msg.chat_id_,true,
  matrex..'mute_photo'..msg.chat_id_,true,
  matrex..'mute_audio'..msg.chat_id_,true,
  matrex..'mute_voice'..msg.chat_id_,true,
  matrex..'mute_sticker'..msg.chat_id_,true,
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  redis:del(
  matrex..'lock_username'..msg.chat_id_,
  matrex..'mute_gif'..msg.chat_id_,
  matrex..'mute_photo'..msg.chat_id_,
  matrex..'mute_audio'..msg.chat_id_,
  matrex..'mute_voice'..msg.chat_id_,
  matrex..'mute_sticker'..msg.chat_id_,
  matrex..'mute_forward'..msg.chat_id_,
  matrex..'mute_contact'..msg.chat_id_,
  matrex..'mute_location'..msg.chat_id_,
  matrex..'mute_document'..msg.chat_id_,
  matrex..'lock_link'..msg.chat_id_,
  matrex..'lock_tag'..msg.chat_id_,
  matrex..'lock_edit'..msg.chat_id_,
  matrex..'lock_spam'..msg.chat_id_,
  matrex..'lock_bots'..msg.chat_id_,
  matrex..'lock_webpage'..msg.chat_id_,
  matrex..'mute_video'..msg.chat_id_,
  matrex..':tqeed_video:'..msg.chat_id_,
  matrex..':tqeed_photo:'..msg.chat_id_,
  matrex..':tqeed_gif:'..msg.chat_id_,
  matrex..':tqeed_fwd:'..msg.chat_id_,
  matrex..':tqeed_link:'..msg.chat_id_,
  matrex..'mute_inline'..msg.chat_id_
  )
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**تــــم فتح الكل  \n✓"
  end
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(matrex..':tqeed_photo:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالصور بالتأكيد تــــم قفله \n✓'
  else
  redis:del(matrex..'mute_photo'..msg.chat_id_)
  redis:set(matrex..':tqeed_photo:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(matrex..':tqeed_photo:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالصور بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..':tqeed_photo:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(matrex..':tqeed_video:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالفيديو بالتأكيد تــــم قفله \n✓'
  else
  redis:del(matrex..':tqeed_video:'..msg.chat_id_)
  redis:set(matrex..':tqeed_video:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(matrex..':tqeed_video:'..msg.chat_id_) then
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(matrex..':tqeed_gif:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد المتحركه بالتأكيد تــــم قفله \n✓'
  else
  redis:del(matrex..'mute_gif'..msg.chat_id_)
  redis:set(matrex..':tqeed_gif:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(matrex..':tqeed_gif:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد المتحركه بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..':tqeed_gif:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(matrex..':tqeed_fwd:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالتوجيه بالتأكيد تــــم قفله \n✓'
  else
  redis:del(matrex..'mute_forward'..msg.chat_id_)
  redis:set(matrex..':tqeed_fwd:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(matrex..':tqeed_fwd:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد التوجيه بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..':tqeed_fwd:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(matrex..':tqeed_link:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالروابط بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..':tqeed_link:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(matrex..':tqeed_link:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالروابط بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..':tqeed_link:'..msg.chat_id_)
  ...
  if redis:get(matrex..'lock_twasel') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التواصل بالتاكيد تــــم تعطيله \n✓'
  else
  redis:set(matrex..'lock_twasel',true)
  ...
  if not redis:get(matrex..'lock_brod') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**اذاعه المطورين بالتاكيد تــــم تعطيله \n✓'
  else
  redis:del(matrex..'lock_brod')
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تعطيل اذاعه المطورين  \n✓'
  end
  end
  function unlock_brod(msg)
  if not msg.SudoBase then return "-**هذا الامر يخص المطور فقط  ❕" end
  if redis:get(matrex..'lock_brod') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**اذاعه المطورين بالتاكيد تــــم تفعيله \n✓'
  else 
  redis:set(matrex..'lock_brod',true)
  ...
  if not redis:get(matrex..'replay'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الردود بالتاكيد تــــم تعطيله \n✓'
  else
  redis:del(matrex..'replay'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تعطيل الردود  \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'replay'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الردود بالتاكيد تــــم تفعيله \n✓'
  else 
  redis:set(matrex..'replay'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تفعيل الردود  \n✓'
  end
  end
  ...
  if not msg.SudoBase then return "-**هذا الامر يخص المطور الاساسي فقط  \n❕" end
  if not redis:get(matrex..'lock_service') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
  else
  redis:del(matrex..'lock_service')
  ...
  redis:set(matrex..'lock_service',true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_link'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الروابط بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'lock_link'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الروابط \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_link'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الروابط بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'lock_link'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الروابط \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_tag'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التاك بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_tag'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التاك (#) \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_tag'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التاك بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'lock_tag'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التاك  \n✓'
  end
  end
  ---------------Lock UserName-------------------
  ...
  if redis:get(matrex..'lock_username'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**المعرفات بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_username'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل المعرفات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_username'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**آلمـعرفآت بآلتآگيد تــــم فتحهآ  \n✓'
  else 
  redis:del(matrex..'lock_username'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_edit'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التعديل بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_edit'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التعديل \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_edit'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التعديل بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'lock_edit'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التعديل \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if   redis:get(matrex..'lock_spam'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكلايش بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'lock_spam'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الكلايش \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_spam'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكلايش بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'lock_spam'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الكلايش \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_flood'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التكرار بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_flood'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التكرار \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_flood'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التكرار بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'lock_flood'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التكرار \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_bots'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'lock_bots'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل البوتات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_bots'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'lock_bots_by_kick'..msg.chat_id_)
  redis:del(matrex..'lock_bots'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح البوتات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_join'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاضافه بالتاكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'lock_join'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الاضافه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_join'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاضافه بالتاكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'lock_join'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الاضافه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_markdown'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الماركدوان بالتاكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_markdown'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_markdown'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الماركدوان بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'lock_markdown'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_webpage'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الويب بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_webpage'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الويب \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_webpage'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الويب بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'lock_webpage'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الويب \n✓'
  end
  end
  ---------------Mute Gif-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_gif'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**المتحركه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_gif'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل المتحركه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_gif'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_inline'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الانلاين بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'mute_inline'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الانلاين \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_inline'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الانلاين بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'mute_inline'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الانلاين \n✓'
  end
  end
  ---------------Mute Text-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_text'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الدرشه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_text'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الدردشه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_text'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الدردشه بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_text'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الدردشه \n✓'
  end
  end
  ---------------Mute photo-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_photo'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصور بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_photo'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الصور \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_photo'..msg.chat_id_)then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_video'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الفيديو بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'mute_video'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الفيديو \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_video'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الفيديو بتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'mute_video'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الفيديو \n✓'
  end
  end
  ---------------Mute Audio-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_audio'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البصمات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_audio'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل البصمات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_audio'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البصمات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_audio'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح البصمات \n✓'
  end
  end
  ---------------Mute Voice-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if   redis:get(matrex..'mute_voice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصوت بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'mute_voice'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الصوت \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_voice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصوت بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'mute_voice'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الصوت \n✓'
  end
  end
  ---------------Mute Sticker-------------------
  ...
  if   redis:get(matrex..'mute_sticker'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملصقات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_sticker'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الملصقات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_sticker'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملصقات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_sticker'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الملصقات \n✓'
  end
  end
  ---------------Mute Contact-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_contact'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**جهات الاتصال بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_contact'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_contact'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**جهات الاتصال بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_contact'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_forward'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التوجيه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_forward'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التوجيه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_forward'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_location'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الموقع بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'mute_location'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الموقع \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_location'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الموقع بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'mute_location'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الموقع \n✓'
  end
  end
  ---------------Mute Document-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_document'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملفات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(matrex..'mute_document'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الملفات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_document'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملفات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_document'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الملفات \n✓'
  end
  end
  ---------------Mute TgService-------------------
  ...
  redis:set(matrex..'mute_tgservice'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_tgservice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاشعارات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(matrex..'mute_tgservice'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'mute_keyboard'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكيبورد بالتأكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'mute_keyboard'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الكيبورد \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'mute_keyboard'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكيبورد بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(matrex..'mute_keyboard'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الكيبورد \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_bots_by_kick'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالطرد بالتاكيد تــــم قفله \n✓'
  else
  redis:set(matrex..'lock_bots'..msg.chat_id_,true)
  redis:set(matrex..'lock_bots_by_kick'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_bots_by_kick'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(matrex..'lock_pin'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التثبيت بالفعل مقفل \n✓'
  else
  redis:set(matrex..'lock_pin'..msg.chat_id_,true) 
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تـم قفل التثبيت \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(matrex..'lock_pin'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التثبيت بالفعل مفتوح \n✓'
  else 
  redis:del(matrex..'lock_pin'..msg.chat_id_)
  return '- **أهلا عزيزي '..msg.TheRankCmd..'\n- **تـم فتح التثبيت   \n✓'
  end
  end
